...
int i = 1;
    ...
    public boolean update() {
        ...
        try {            
            con.bukaKoneksi();
            con.preparedStatement = con.dbKoneksi.prepareStatement("update customer set nama = ?, alamat = ?, total = ? ,status = ? where  getIdMember = ? ");
    ...
    public ObservableList<CustModel>  kontolcust(String kode, String nama) {
        try {    
